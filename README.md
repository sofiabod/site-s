...
The 2025 `photos` array keeps the original gallery. Each entry has `src`, `alt`, and an event `href`. Both years support an optional `cover` image for the hover reveal; Z Fellows uses this effect on its two photos.
